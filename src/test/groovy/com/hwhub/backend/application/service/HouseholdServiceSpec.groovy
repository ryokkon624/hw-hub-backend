...
class HouseholdServiceSpec extends Specification {
    ...
    def "createHousehold は世帯を作成し、作成者をメンバーとして登録して返す"() {
        ...
        Long userId = 100L
        String name = "My Home"
        def userProfile = UserModel.reconstruct(userId, "user@example.com", "pass", null, com.hwhub.backend.domain.enums.AuthProvider.LOCAL.code, null, "Taro", "ja", true, null, null, true, null, null)
